...
// in simulator we redefine to format for VMAP2013 Developer console
...
{\
	NSString * exceptionName = [@"org.vmap2013." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vmap2013";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIVMAP2013NativeItemNone = -1, 
	UIVMAP2013NativeItemSpinner = -2,
	UIVMAP2013NativeItemProgressBar = -3,
	
	UIVMAP2013NativeItemSlider = -4,
	UIVMAP2013NativeItemSwitch = -5,
	UIVMAP2013NativeItemMultiButton = -6,
	UIVMAP2013NativeItemSegmented = -7,
	
	UIVMAP2013NativeItemTextView = -8,
	UIVMAP2013NativeItemTextField = -9,
	UIVMAP2013NativeItemSearchBar = -10,
	
	UIVMAP2013NativeItemPicker = -11,
	UIVMAP2013NativeItemDatePicker = -12,
	
	UIVMAP2013NativeItemInfoLight = -13,
	UIVMAP2013NativeItemInfoDark = -14,
	
	UIVMAP2013NativeItemDisclosure = -15,
	
	UIVMAP2013NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VMAP2013 instances of
