 ...
 * Copyright (c) 2009-2011 by VMAP2013, Inc. All Rights Reserved.
...
//@interface VMAP2013Object : NSObject
//@end

@interface VMAP2013Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VMAP2013Object class]])
		{
			for (NSString *key in [[(VMAP2013Object*)o modules] allKeys])
			{
