...
static NSString * const kVMAP2013Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_vmap2013Injection
{
	...
	[html appendString:kVMAP2013Javascript];
...
{
	// attempt to make well-formed HTML and inject in our VMAP2013 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _vmap2013Injection]];
