...
/**
 The base class for all VMAP2013 modules
 */
...
/**
 VMAP2013 Platform calls this method on startup.
 */
-(void)startup;

/**
 VMAP2013 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 VMAP2013 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 VMAP2013 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 VMAP2013 Platform calls this method on resume.
 @param sender The sender of the event.
 */
