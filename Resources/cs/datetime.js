(function() {	
	 ...
	 */
	Lhs.datetime.strtotime = function (str, now) {
	...
	Lhs.datetime.prettyDate = function (time) {
	...
	Lhs.datetime.getTwitterInterval = function (strDateTime) {
	    return Lhs.datetime.prettyDate(Lhs.datetime.strtotime(strDateTime));
	};
	
	Lhs.datetime.dayToName = function (day) {
	    switch (day) {
	    case 0:
	        return 'Sunday';
	    case 1:
	...
	Lhs.datetime.monthToName = function (month) {
	    switch (month) {
	    case 1:
	        return 'January';
	    case 2:
	...
	Lhs.datetime.cleanDate = function (date) {
	    var label;
	    switch (date.getDate()) {
	    case 1:
	        label = 'st';
	    ...
	    return Lhs.datetime.dayToName(date.getDay()) + ', ' + Lhs.datetime.monthToName(date.getMonth() + 1) + ' ' + date.getDate() + label;
	};
	
	Lhs.datetime.cleanTime = function (time) {
